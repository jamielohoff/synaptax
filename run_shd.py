...
init_fn_xavier = initializers.xavier_normal()

init_fn_orthogonal = initializers.orthogonal(jnp.sqrt(2))

W = init_fn_orthogonal(wkey, (NUM_HIDDEN, NUM_CHANNELS))
V = jnp.zeros((NUM_HIDDEN, NUM_HIDDEN))
W_out = init_fn_xavier(woutkey, (NUM_LABELS, NUM_HIDDEN)) # initialzie with xavier normal.
